...
<?php } else { echo '<img src="'.get_bloginfo("template_url").'/css/img/no-img-140x140.gif" alt="No image" />'; } ?>

<div class="text">
<?php the_content('<span class="more-link" title="Read More">Read More</span>'); ?>
<hr />
<div class="readMore">
